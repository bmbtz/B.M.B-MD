...
var session = conf.session.replace(/MR-B.M.B-MD;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '255711782669';
            const dj2 = '255711782669';
            const dj3 = "255711782669";
            const luffy = '255711782669';
            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message supprimer me concernant') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `        🪅MR-B.M.B-MD DELETED INFORMATION🪅\n Message from @${msg.key.participant.split('@')[0]}​` , mentions : [msg.key.participant]},)
                                .then( () => {
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by mr-b.m.b- Md.`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ Mr-b.m.b-md connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Boniphace Md by B.M.B installing cmds😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + "Successfully installed MR-B.M.B-MD commands✔️");
                        }
                        catch (e) {
                ...
                console.log(MR-B.M.B-MD successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `MR-B.M.B-MD IS RUNNING NOW...
...
> THANK YOU FOR CHOOSING MR-B.M.B-MD .\n`;
                await zk.sendMessage("255711782669@s.whatsapp.net", { text: cmsg });
                }
            }
